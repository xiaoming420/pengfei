...
define('LIUYAN_ERROREPHONE','手机格式不对');
 ...
 //---------SEARCH 
 define('SEARCHTITLE','Recherche sur le site web de');
  define('SEARCH_BTN','搜索');
  define('SEARCH_KEYWORDS','mot clé');
  define('SEARCH_ALERTKEYWORDS','Saisie de mots clefs');
  define('SEARCH_ALERTLONG','对不起，您输入的关键字太长');
  define('SEARCH_RESULT','résultats de la recherche');
