...
GLOBAL $banner;GLOBAL $bannertext;
	 ...
	 // pre($row2);
		...
		//=====================begin replace====
		 ...
		 //--------judge homepage--------------
			...
			Global $bsbanner;Global $bsbannertext;Global $bsbannermob;Global $pidregion;Global $bsindexmob;
			Global $alias;
			 
			if($alias=='index'){		 
				//default is pc:
				if($bsbanner<>'') $banner= $bsbanner;
				if($bsbannertext<>'') $bannertext= $bsbannertext;
