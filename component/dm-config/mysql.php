...
{
echo  '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />对不起，数据库名，用户或密码不对，请修改mysql.php，具体看官方教程。sorry,database name maybe is wrong:<br> pls visit later';
}
