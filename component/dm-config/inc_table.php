...
define('TABLE_VIDEO', 'zzz_video');
define('TABLE_BLOCK', 'zzz_block');
define('TABLE_BLOCKGROUP', 'zzz_blockgroup');
define('TABLE_COLUMN', 'zzz_column');
...
define('TABLE_TAG', 'zzz_tag');
define('TABLE_TAGNODE', 'zzz_tagnode');
