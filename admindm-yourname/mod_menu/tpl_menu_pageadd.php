...
$ss = "insert into ".TABLE_MENU." (ppid,pid,pidname,type,pbh,lang) values ('$ppid','$abc2','$abc1','page','$user2510','".LANG."')"; 
  //echo $ss;exit;  
    iquery($ss); 
	//	alert('添加成功!');
		jump($jumpv);
        ...
        <option value="">请选择：</option>
          ...
          if(getnum($sql)>0) {
             ...
             foreach($rowall as $v){
               ...
               $sql2 = "SELECT * from ".TABLE_MENU." where ppid='$ppid' and pidname='$pidname'   $andlangbh order by id";
...
<br />
 ...
 <tr>
    ...
    <td>  <select name="menucate">
          ...
          <?php 
          $sql = "SELECT * from ".TABLE_MENU." where ppid='$ppid' and pid='0' and type<>'cate' $andlangbh order by pos desc,id";
           if(getnum($sql)>0) {
