...
?>
 ...
 <a class="<?php echo $edit_layoutlist_cur;?>"  href="<?php echo $jumpv_tid;?>&file=mainlayoutlist&act=edit"><span>主分类列表布局</span></a>
 

 
 <a  class="<?php echo $edit_layoutdetail_cur;?>"  href="<?php echo $jumpv_tid;?>&file=mainlayoutdetail&act=edit"><span>主分类详情页布局</span></a>
