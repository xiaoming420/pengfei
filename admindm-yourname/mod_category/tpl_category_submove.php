...
if(!defined('IN_DEMOSOSO')) {
 ...
 if($act=='update'){  
  ...
  //echo $abc1;
		  ...
		  else {echo '<p><i class="fa fa-exclamation-circle"></i> 要转移的分类还没有内容！</p>';exit;}
  ...
  $moveactionupdate = $jumpv_fp.'&act=update';;
...
<tr>
    ...
    <td width="88%">
	<?php	
 $sql_sel = "select pidname,name from  ".TABLE_CATE." where pid='0' and pidname<>'$catid' $andlangbh order by pos desc,id";
