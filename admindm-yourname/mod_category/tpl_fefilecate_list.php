...
//else $where = " and  sta_visible='y'";
  ...
  $sql2 = "SELECT * from ".TABLE_CATE." where  pid= '$catepidname' and modtype='blockdh' $andlangbh  order by pos desc,id desc";
   //echo $sql2;
...
//mod_node/mod_blockdh.php?lang=cn&pid=vblock20170420_1158241500
 $gllink = '../mod_node/mod_blockdh.php?lang='.LANG.'&pid='.$pidnamehere;
$gl_text= '<a class="titletolist2"  style="font-size:14px;color:#007ACC;font-weight:bold"  href="'.$gllink.'">'.$name.'</a>'; 
