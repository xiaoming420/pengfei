...
*/
	...
	if($act=='insert'){
			...
			$catbs='cate'.$bshou;
			$ss = "insert into ".TABLE_CATE." (pid,pidname,pbh,name,alias,last,level,lang,arr_can) values ('0','$catbs','$user2510','$abc1','$abc2','y',1,'".LANG."','$arr_maincateV')";
			 //echo $ss;exit;
			iquery($ss);
			//insert into menu--------------	
...
//insert catefg into layout ---no use,bec use commonfg.
//$pidname='layfg'.$bshou;
//$ss = "insert into ".TABLE_LAYOUT." (pid,pidname,pidstylebh,pbh,lang,type,arr_fg,dateedit) values ('$catbs','$pidname','$curstyle','$user2510','".LANG."','fg','$arr_fgV','$dateall')";
//iquery($ss);
