...
if($sta_title<>'y') echo '<p class="hintbox">提示：标题已设置为不显示</p>';
 ...
 <tr  style="background:#fff">
      <td  class="tr">标题的位置：</td>
     <td >     
       
<select name="sta_title_posi"> <?php select_from_arr($arr_leftright,$sta_title_posi,'');?>
     </select>
  ...
  <span class="cgray">试下： color:red </span>
     ...
     <tr>
      ...
      <td >      
          ...
          ?><br />
        <span class="cgray">默认会有颜色，如果为hide则隐藏 </span>
        <br /> (<a target="_blank" href="http://www.demososo.com/color.html">配色方案</a>)
   </td>
    </tr> 
...
<?php 
          ...
          ?><br />
        <span class="cgray">默认会有颜色，如果为none则隐藏 </span>


<div class="c5"> </div>

使用图标：
 <input  name="titlelineawe" type="text" value="<?php echo $titlelineawe?>"    /> 
<?php echo $xz_maybe;?> 

<?php 
if($titlelineawe<>'') echo '<p><i class="fa '.$titlelineawe.'"></i></p>';
?>
...
<span class="cgray">试下：fa-pagelines 或  fa-bookmark 或 fa-asterisk
 ...
 <p class="cgray">如果使用图标，则短下划线的颜色不起作用。</p>
...
<td colspan="2" class="trbg">
  链接的样式 
  <a href="http://www.demososo.com/detail-99.html" target="_blank" style="color:#ccc">什么是更多的链接?</a> 
</td></tr>
