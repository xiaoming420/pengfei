...
$ss = "insert into ".TABLE_NODE." (ppid,pid,pidname,pbh,title,lang,arr_can,sta_noaccess,dateday,dateedit,dateadd) values ('$catpid','$abc2','$pidname','$user2510','$abc1','".LANG."','$arr_nodeV','$sta_noaccess','$dateday','$dateall','$dateall')";
//echo $ss;exit;
iquery($ss);
//alert("添加成功");
