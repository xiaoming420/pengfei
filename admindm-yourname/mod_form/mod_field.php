...
//
$jumpv='mod_field.php?lang='.LANG.'&pid='.$pid;
...
$title = get_field(TABLE_FIELD,'name',$pid,'pidname'); 
$title2=$title3='';
 $result = ' - <a target="_blank" href="../mod_comment/mod_comment.php?lang='.LANG.'&catid=formblock&catpid='.$pid.'">结果</a>';
if($act=='list') $title2= '<a style="font-size:18px" href="mod_form.php?lang='.LANG.'">表单区块管理</a> - '.$title.$result;
else $title2 = '表单区块管理 - <a style="font-size:18px" href="'.$jumpv.'">'.$title.'</a>';
...
<?php
  ...
  require_once HERE_ROOT.'mod_form/tpl_field_'.$file.'.php'; 	 
?>
</section>
<?php
