...
<?php
 $sqlsub = "SELECT * from ".TABLE_FIELD." where  pid='block' $andlangbh and type='block' order by pos desc,id";
...
<div class="">
 ...
 ?>
      ...
      <td align="center"><?php echo $gl;?><span class="cred">(<?php echo $num;?>)</span></td>
