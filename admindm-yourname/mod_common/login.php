...
?>
 ...
 <div class="tc" style="padding-top:15px">建议用chrome或firefox，不要用IE
 <br />

 power by <a href="http://www.demososo.com" target="_blank">demososo.com</a></div>		  
...
function navlang_main(){
	// no  use..............define lang to cn first.
//use in common.php //must give first in mysql
