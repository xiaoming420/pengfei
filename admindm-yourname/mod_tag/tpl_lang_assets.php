...
*/
 ...
 <tr>
  <td class="tr">CDN缓存：
    <br />
    <span class="cgray">默认配置在根目录的 dm-config/config.php 里。<br />
      如果这里设置了，则系统会使用这里的值。
    </span>

    <br />  
    <a href="http://www.demososo.com/dm_assests.html" target="_blank">查看使用教程></a>
  </td>
  <td>
   jquery ：<input name="jquery" type="text"  value="<?php echo $jquery;?>" class="form-control" > <?php echo $xz_maybe;?>
   <div class="c5"></div>
   compress.js ： <input name="compressjs" type="text"  value="<?php echo $compressjs;?>" class="form-control" > <?php echo $xz_maybe;?>
   <div class="c5"></div>
    compresscss ： <input name="compresscss" type="text"  value="<?php echo $compresscss;?>" class="form-control" > <?php echo $xz_maybe;?>
   <div class="c5"></div>
