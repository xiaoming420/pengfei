...
<tr>
<td   align="center">标签  <a href="mod_tag.php?lang=cn&file=viewnode">(所有)</a></td>
...
$tid = get_field(TABLE_NODE,'id',$node,'pidname');
 ...
 ?>
	 ...
	 [<a target="_blank" href="../mod_node/mod_node_edit.php?lang=cn&tid=<?php echo $tid;?>&act=list&file=edittag">修改</a>]
