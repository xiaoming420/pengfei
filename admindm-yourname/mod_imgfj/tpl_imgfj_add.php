...
if($act=='insert'){
	...
	if(!empty($imgname)){
		...
		/********************/
	$ss = "insert into ".TABLE_IMGFJ." (pbh,pid,pidstylebh,lang,title,kv,size,dateedit) values ('$user2510','$pid','$curstyle','".LANG."','$titlehere','$return_v',$imgsize,'$dateall')";//no pos,because pos is auto,is to next and prev page
    //echo $ss;exit;
...
<div class="c5"> </div>
       加上水印<input type="checkbox"   name="water"  value="y" size="10" />  &nbsp;&nbsp;&nbsp;
