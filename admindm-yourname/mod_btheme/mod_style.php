...
if($file=='edit_can') { $title2 =' - 修改模板 ('.$mbname.') ';
$edit_cur ='active';}
if($file=='edit_blockid') { $title2=' - 修改标识 ('.$mbname.') ';
$editblockid_cur ='active';}
/*
...
<section class="content-header">
  ...
  <?php   
 if($act=='edit')    require_once HERE_ROOT.'mod_btheme/tpl_style_tab.php';
    ?>

 <section class="content">       
        <?php   
        if($file=='edit_cssdesp' || $file=='edit_csssql' || $file=='edit_cssactive')      
            require_once HERE_ROOT.'mod_btheme/tpl_style_edit_cssPAGE.php';
          else  require_once HERE_ROOT.'mod_btheme/tpl_style_'.$file.'.php';
        ?>
 </section>
<?php
