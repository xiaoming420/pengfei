...
if($pid<>''){
if($type=='common'  or $type=='page' or $type=='cate' or  $type=='read'){
...
if($act=='insert'){
	   ...
	   $pidname='layout'.$bshou;
		 $ss = "insert into ".TABLE_LAYOUT." (pid,pidname,pidstylebh,pbh,lang,type,dateedit) values ('$pid','$pidname','$curstyle','$user2510','".LANG."','$type','$dateall')";
		 iquery($ss);
		 $jumpv2 = $jumpv.'&pid='.$pid.'&catid='.$catid.'&type='.$type;
		 jump($jumpv2);
	  }
